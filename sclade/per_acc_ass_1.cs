...
namespace sclade
{
    public partial class per_acc_ass_1 : Form
    {
        ...
        public per_acc_ass_1(NpgsqlConnection con, int id_em)
        {
            this.con = con;
            InitializeComponent();
            this.id_em = id_em;
        ...
        private void per_acc_ass_1_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        {
            storehouse fp = new storehouse(con, -4, "", this.div, "");
            fp.Show();
        }
        ...
        private void button32_Click(object sender, EventArgs e)
        {
            if (this.id_em != -1)
            {
                if (comboBox2.SelectedValue != null)
                {
                    batch_number fp = new batch_number(con, -1, "", -1, -1, (int)comboBox2.SelectedValue, div);
                    fp.Show();
                }
                else
                {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            if (this.id_em != -1)
            {
                if (comboBox2.SelectedValue != null)
                {
                    navig fp = new navig(con, (int)comboBox2.SelectedValue, div);
                    fp.Show();
                }
                else
                {
        ...
        private void button36_Click(object sender, EventArgs e)
        {
            if (this.id_em != -1)
            {
                if (comboBox2.SelectedValue != null)
                {
                    invoices_in fp = new invoices_in(con, (int)comboBox2.SelectedValue, this.id_em, "", 1, div);
                    fp.Show();
                }
                else
                {
                    invoices_in fp = new invoices_in(con, -1, this.id_em, "", 1, div);
                    fp.Show();
                }
            }
        ...
        private void button14_Click(object sender, EventArgs e)
        {
            if (this.id_em != -1)
            {
                if (comboBox2.SelectedValue != null)
                {
                    invoices_ fp = new invoices_(con, (int)comboBox2.SelectedValue, this.id_em, "", 1, div);
                    fp.Show();
                }
                else
                {
                    invoices_ fp = new invoices_(con, -1, this.id_em, "", 1, div);
                    fp.Show();
                }
            }
            ...
            try
            {
                if (this.id_em != -1)
                {
                    if (div != null)
                    {
                        ...
                        storehouse fp = new storehouse(con, -3, "", div, "");
                        fp.ShowDialog();
                        if (fp.name != "")
                        {
                            stor = fp.id_c;
        ...
        private void per_acc_ass_1_FormClosing_1(object sender, FormClosingEventArgs e)
        {
            Application.Exit();
        }
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            if (this.id_em != -1)
            {
                if (comboBox2.SelectedValue != null)
                {
                    moving fp = new moving(con, (int)comboBox2.SelectedValue, this.id_em, -1, "", 1, div);
                    fp.Show();
                }
                else
                {
                    moving fp = new moving(con, -1, this.id_em, -1, "", 1, div);
                    fp.Show();
                }
            }
        }
        ...
        private void button11_Click(object sender, EventArgs e)
        {
            if (this.id_em != -1)
            {
                if (comboBox2.SelectedValue != null)
                {
                    mov_pro fp = new mov_pro(con, (int)comboBox2.SelectedValue, "", this.id_em, -1, div);
                    fp.Show();
                }
                else
                {
                    mov_pro fp = new mov_pro(con, -1, "", this.id_em, -1, div);
                    fp.Show();
                }
            }
        }
        ...
        {
            organization fp = new organization(con);
            fp.Show();
        }
        ...
        private void button13_Click(object sender, EventArgs e)
        {
            if (this.id_em != -1)
            {
                if (comboBox2.SelectedValue != null)
                {
                    product_place fp = new product_place(con, this.stor, "", this.id_em, -1, div);
                    fp.Show();
                }
                else
                {
                    product_place fp = new product_place(con, -1, "", this.id_em, -1, div);
                    fp.Show();
                }
            }
        ...
        private void button15_Click(object sender, EventArgs e)
        {
            if (this.id_em != -1)
            {
                if (comboBox2.SelectedValue != null)
                {
                    product_shipment fp = new product_shipment(con, this.stor, "", this.id_em, -1, div);
                    fp.Show();
                }
                else
                {
                    product_shipment fp = new product_shipment(con, -1, "", this.id_em, -1, div);
                    fp.Show();
                }
            }
        }
        ...
        private void button16_Click(object sender, EventArgs e)
        {
            if (this.id_em != -1)
            {
                if (comboBox2.SelectedValue != null)
                {
                    product_accounting fp = new product_accounting(con, this.stor, "", this.id_em, -1, div);
                    fp.Show();
                }
                else
                {
                    product_accounting fp = new product_accounting(con, -1, "", this.id_em, -1, div);
                    fp.Show();
                }
            }
        }
