...
namespace sclade
{
    public partial class Type_to : Form
    {
        ...
        public Type_to(NpgsqlConnection con, int id, string name)
        {
            this.name = name;
            this.id = id;
            this.con = con;
        ...
        private void Type_to_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        public void Update()
            ...
            if (textBox1.Text == "")
            {
                String sql = "Select * from Type_to ORDER BY name ASC";
            ...
            {
                String sql = "Select *  from Type_to where name ILIKE '";
                sql += textBox1.Text;
        ...
        private void изменитьToolStripMenuItem_Click(object sender, EventArgs e)
            ...
            newType_to f = new newType_to(con, id, name, descr);
            f.ShowDialog();
            Update();
                //description(id);
            }
        ...
        private void удалитьToolStripMenuItem_Click(object sender, EventArgs e)
            ...
            NpgsqlCommand command = new NpgsqlCommand("DELETE FROM Type_to WHERE id=:id", con);
        ...
        private void ExportToExcel_all(DataGridView dataGridView, string filePath)
        {
            try
            {
                ...
                //worksheet.Cells[1, 1].Range.Text = "Название"; // Заголовок для второго столбца
                //worksheet.Cells[1, 2].Range.Text = "Описание"; // Заголовок для второго столбца
        ...
        private void ExportToWord_all(DataGridView dataGridView, string filePath)
        {
            ...
            try
            {
                ...
                titleParagraph.Range.Text = "Типы товаров";
        ...
        private void ExportToWord(DataGridView dataGridView, string filePath)
        {
            ...
            try
            {
                if (dataGridView1.CurrentRow != null && dataGridView1.CurrentRow.Cells[0].Value != null)
                {
                    ...
                    // Добавляем заголовок
                    Word.Paragraph titleParagraph = wordDoc.Content.Paragraphs.Add();
                    titleParagraph.Range.Text = "Тип товара";
                    titleParagraph.Range.Font.Name = "Arial"; // Устанавливаем шрифт
                    titleParagraph.Range.Font.Size = 12;
        ...
        private void вExcelИнформациюВсехПартийToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                using (SaveFileDialog saveFileDialog = new SaveFileDialog())
                {
                    ...
                    saveFileDialog.FileName = "Type_" + DateTime.Today.Date.Day.ToString() + "_" + DateTime.Today.Date.Month.ToString() + "_" + DateTime.Today.Date.Year.ToString() + ".xlsx"; // Имя файла по умолчанию
            ...
            try
            {
                ...
                if (dataGridView1.CurrentRow != null && dataGridView1.CurrentRow.Cells[0].Value != null)
                {
                    ...
                    using (SaveFileDialog saveFileDialog = new SaveFileDialog())
                    {
                        ...
                        saveFileDialog.FileName = "Type_" + code.Replace(" ", "_") + "_" + DateTime.Today.Date.Day.ToString() + "_" + DateTime.Today.Date.Month.ToString() + "_" + DateTime.Today.Date.Year.ToString() + ".xlsx"; // Имя файла по умолчанию
        ...
        private void вWordИнформациюВсехТоваровToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                using (SaveFileDialog saveFileDialog = new SaveFileDialog())
                {
                    ...
                    saveFileDialog.FileName = "Type_" + DateTime.Today.ToString("dd_MM_yyyy") + ".docx"; // Имя файла по умолчанию
            ...
            try
            {
                if (dataGridView1.CurrentRow != null && dataGridView1.CurrentRow.Cells[0].Value != null)
                {
                    using (SaveFileDialog saveFileDialog = new SaveFileDialog())
                    {
                        ...
                        saveFileDialog.Title = "Сохранить файл Word";
                        string code = (string)dataGridView1.CurrentRow.Cells[1].Value;
                        saveFileDialog.FileName = "Type_" + code.Replace(" ", "_") + "_" + DateTime.Today.ToString("dd_MM_yyyy") + ".docx"; // Имя файла по умолчанию
        ...
        private void вJSONИнформациюВсехТоваровToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                using (SaveFileDialog saveFileDialog = new SaveFileDialog())
                {
                    ...
                    saveFileDialog.FileName = $"Type_{DateTime.Today.Day}_{DateTime.Today.Month}_{DateTime.Today.Year}.json";
            ...
            try
            {
                if (dataGridView1.CurrentRow != null && dataGridView1.CurrentRow.Cells[0].Value != null)
                {
                    using (SaveFileDialog saveFileDialog = new SaveFileDialog())
                    {
                        ...
                        saveFileDialog.Title = "Сохраните файл JSON как";
                        string code = (string)dataGridView1.CurrentRow.Cells[1].Value;
                        saveFileDialog.FileName = $"Type_{code.Replace(" ", "_")}_{DateTime.Today.Day}_{DateTime.Today.Month}_{DateTime.Today.Year}.json";
