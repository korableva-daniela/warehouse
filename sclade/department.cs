...
namespace sclade
{
    ...
    public partial class department : Form
    {
        ...
        public department(NpgsqlConnection con)
        {
            this.con = con;
            InitializeComponent();
        ...
        private void изменитьToolStripMenuItem_Click(object sender, EventArgs e)
            ...
            newdepat f = new newdepat(con, id, name, descr);
            f.ShowDialog();
            Update();
                                //description(id);
                            }
        ...
        private void удалитьToolStripMenuItem_Click(object sender, EventArgs e)
            ...
            NpgsqlCommand command = new NpgsqlCommand("DELETE FROM Department WHERE id=:id", con);
