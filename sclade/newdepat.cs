...
namespace sclade
{
    public partial class newdepat : Form
    {
        public int id;
        public string name;
        ...
        public newdepat(NpgsqlConnection con, int id, string name, string description)
        {
            this.id = id;
            this.con = con;
        ...
        private void newdepat_Load(object sender, EventArgs e)
        {
            try
            {
