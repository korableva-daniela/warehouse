...
namespace sclade
{
    public partial class excise : Form
    {
        public string numexcise;
        Regex regex1 = new Regex(@"^\d{1,13}$");
        ...
        public excise(NpgsqlConnection con, string numexcise)
        {
            this.con = con;
        ...
        private void excise_Load(object sender, EventArgs e)
        {
