...
namespace sclade
{
    public partial class country_of_origin : Form
    {
        ...
        public country_of_origin(NpgsqlConnection con)
        {
            this.con = con;
            InitializeComponent();
        ...
        private void country_of_origin_Load(object sender, EventArgs e)
        {
            Update();
        ...
        public void Update()
        {
            try
            {
                ...
                {
                    String sql = "Select *  from country_of_origin ORDER BY  code ASC;";
                ...
                {
                    String sql = "Select *  from country_of_origin where code ILIKE '";
                    sql += textBox1.Text;
                ...
                {
                    String sql = "Select *  from country_of_origin where name ILIKE '";
                    sql += textBox2.Text;
                    sql += "%' ORDER BY  code ASC;";
                    NpgsqlDataAdapter da = new NpgsqlDataAdapter(sql, con);
                    ds.Reset();
                ...
                {
                    String sql = "Select *  from country_of_origin where litter ILIKE '";
                    sql += textBox3.Text;
                    sql += "%' ORDER BY  code ASC;";
                    NpgsqlDataAdapter da = new NpgsqlDataAdapter(sql, con);
                    ds.Reset();
                ...
                dataGridView1.Columns[1].HeaderText = "Код страны производителя";
                dataGridView1.Columns[2].HeaderText = "Название страны производителя";
        ...
        private void добавитьToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                newcountry_of_origin f = new newcountry_of_origin(con, -1, "", "", "");
                f.ShowDialog();
                Update();
            }
            catch { }
        ...
        private void изменитьToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string litter = (string)dataGridView1.CurrentRow.Cells[3].Value;


                newcountry_of_origin f = new newcountry_of_origin(con, id, code, name, litter);
                f.ShowDialog();
                Update();
            }
            catch { }
        ...
        private void удалитьToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                NpgsqlCommand command = new NpgsqlCommand("DELETE FROM country_of_origin WHERE id=:id", con);
        ...
        private void ExportToWord_all(DataGridView dataGridView, string filePath)
        {
            ...
            try
            {
                ...
                titleParagraph.Range.Text = "Коды стран";
        ...
        private void вExcelИнформациюВсехПартийToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                using (SaveFileDialog saveFileDialog = new SaveFileDialog())
                {
                    ...
                    saveFileDialog.FileName = "country_of_origin_" + DateTime.Today.Date.Day.ToString() + "_" + DateTime.Today.Date.Month.ToString() + "_" + DateTime.Today.Date.Year.ToString() + ".xlsx"; // Имя файла по умолчанию
            ...
            try
            {
                ...
                if (dataGridView1.CurrentRow != null && dataGridView1.CurrentRow.Cells[0].Value != null)
                {
                    ...
                    using (SaveFileDialog saveFileDialog = new SaveFileDialog())
                    {
                        ...
                        DateTime time = DateTime.Today.Date;
                        string code = (string)dataGridView1.CurrentRow.Cells[1].Value;
                        saveFileDialog.FileName = "country_of_origin_" + code + "_" + DateTime.Today.Date.Day.ToString() + "_" + DateTime.Today.Date.Month.ToString() + "_" + DateTime.Today.Date.Year.ToString() + ".xlsx"; // Имя файла по умолчанию
        ...
        private void вJSONИнформациюВсехТоваровToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                using (SaveFileDialog saveFileDialog = new SaveFileDialog())
                {
                    ...
                    saveFileDialog.FileName = $"country_of_origin_{DateTime.Today.Day}_{DateTime.Today.Month}_{DateTime.Today.Year}.json";
            ...
            try
            {
                if (dataGridView1.CurrentRow != null && dataGridView1.CurrentRow.Cells[0].Value != null)
                {
                    using (SaveFileDialog saveFileDialog = new SaveFileDialog())
                    {
                        ...
                        saveFileDialog.Title = "Сохраните файл JSON как";
                        string code = (string)dataGridView1.CurrentRow.Cells[1].Value;
                        saveFileDialog.FileName = $"country_of_origin_{code}_{DateTime.Today.Day}_{DateTime.Today.Month}_{DateTime.Today.Year}.json";
        ...
        private void вWordИнформациюВсехТоваровToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                using (SaveFileDialog saveFileDialog = new SaveFileDialog())
                {
                    ...
                    saveFileDialog.FileName = "country_of_origin_" + DateTime.Today.ToString("dd_MM_yyyy") + ".docx"; // Имя файла по умолчанию
            ...
            try
            {
                if (dataGridView1.CurrentRow != null && dataGridView1.CurrentRow.Cells[0].Value != null)
                {
                    using (SaveFileDialog saveFileDialog = new SaveFileDialog())
                    {
                        ...
                        saveFileDialog.Title = "Сохранить файл Word";
                        string code = (string)dataGridView1.CurrentRow.Cells[1].Value;
                        saveFileDialog.FileName = "country_of_origin_" + code + "_" + DateTime.Today.ToString("dd_MM_yyyy") + ".docx"; // Имя файла по умолчанию
