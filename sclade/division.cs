...
namespace sclade
{
    public partial class division : Form
    {
        ...
        public division(NpgsqlConnection con)
        {
            this.con = con;
            InitializeComponent();
        ...
        private void добавитьToolStripMenuItem_Click(object sender, EventArgs e)
            {
                try
                {
                    newdiv f = new newdiv(con, -1, "", DateTime.Today, "","","", "","");
            f.ShowDialog();
            Update();
                }
                catch { }
        ...
        private void изменитьToolStripMenuItem_Click(object sender, EventArgs e)
            ...
            DateTime date_open = (DateTime)dataGridView1.CurrentRow.Cells[2].Value;
            ...
            newdiv f = new newdiv(con, id, name, date_open, country, city, street, house, post_in);
            f.ShowDialog();
            Update();
                    }
                    catch { }
        ...
        private void удалитьToolStripMenuItem_Click(object sender, EventArgs e)
            ...
            NpgsqlCommand command = new NpgsqlCommand("DELETE FROM Division WHERE id=:id", con);
            ...
            try
            {
                ...
                if (dataGridView1.CurrentRow != null && dataGridView1.CurrentRow.Cells[0].Value != null)
                {
                    ...
                    using (SaveFileDialog saveFileDialog = new SaveFileDialog())
                    {
                        ...
                        saveFileDialog.FileName = "Division_" + code.Replace(" ", "_") + "_" + DateTime.Today.Date.Day.ToString() + "_" + DateTime.Today.Date.Month.ToString() + "_" + DateTime.Today.Date.Year.ToString() + ".xlsx"; // Имя файла по умолчанию
            ...
            try
            {
                if (dataGridView1.CurrentRow != null && dataGridView1.CurrentRow.Cells[0].Value != null)
                {
                    using (SaveFileDialog saveFileDialog = new SaveFileDialog())
                    {
                        ...
                        saveFileDialog.Title = "Сохранить файл Word";
                        string code = (string)dataGridView1.CurrentRow.Cells[1].Value;
                        saveFileDialog.FileName = "Division_" + code.Replace(" ", "_") + "_" + DateTime.Today.ToString("dd_MM_yyyy") + ".docx"; // Имя файла по умолчанию
            ...
            try
            {
                if (dataGridView1.CurrentRow != null && dataGridView1.CurrentRow.Cells[0].Value != null)
                {
                    using (SaveFileDialog saveFileDialog = new SaveFileDialog())
                    {
                        ...
                        saveFileDialog.Title = "Сохраните файл JSON как";
                        string code = (string)dataGridView1.CurrentRow.Cells[1].Value;
                        saveFileDialog.FileName = $"Division_{code.Replace(" ", "_")}_{DateTime.Today.Day}_{DateTime.Today.Month}_{DateTime.Today.Year}.json";
