...
namespace sclade
{
    public partial class department_in : Form
    {
        ...
        public department_in(NpgsqlConnection con, int id, string name)
        {
            this.name = name;
            this.id = id;
            this.con = con;
        ...
        private void department_in_Load(object sender, EventArgs e)
                {
                    try
            {
        ...
        private void вExcelИнформациюВсехПартийToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            try
            {
                using (SaveFileDialog saveFileDialog = new SaveFileDialog())
                {
                    ...
                    saveFileDialog.FileName = "department_" + DateTime.Today.Date.Day.ToString() + "_" + DateTime.Today.Date.Month.ToString() + "_" + DateTime.Today.Date.Year.ToString() + ".xlsx"; // Имя файла по умолчанию
        ...
        private void вExcelИнформациюВыбранногоТовараToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dataGridView1.CurrentRow != null && dataGridView1.CurrentRow.Cells[0].Value != null)
                {
                    ...
                    using (SaveFileDialog saveFileDialog = new SaveFileDialog())
                    {
                        ...
                        saveFileDialog.FileName = "department_" + code.Replace(" ", "_") + "_" + DateTime.Today.Date.Day.ToString() + "_" + DateTime.Today.Date.Month.ToString() + "_" + DateTime.Today.Date.Year.ToString() + ".xlsx"; // Имя файла по умолчанию
        ...
        private void вWordИнформациюВсехТоваровToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            try
            {
                ...
                using (SaveFileDialog saveFileDialog = new SaveFileDialog())
                {
                    ...
                    saveFileDialog.FileName = "department_" + DateTime.Today.ToString("dd_MM_yyyy") + ".docx"; // Имя файла по умолчанию
        ...
        private void вWordИнформациюВыбранногоТовараToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            try
            {
                if (dataGridView1.CurrentRow != null && dataGridView1.CurrentRow.Cells[0].Value != null)
                {
                    using (SaveFileDialog saveFileDialog = new SaveFileDialog())
                    {
                        ...
                        saveFileDialog.Title = "Сохранить файл Word";
                        string code = (string)dataGridView1.CurrentRow.Cells[1].Value;
                        saveFileDialog.FileName = "department_" + code.Replace(" ", "_") + "_" + DateTime.Today.ToString("dd_MM_yyyy") + ".docx"; // Имя файла по умолчанию
        ...
        private void вJSONИнформациюВсехТоваровToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            try
            {
                using (SaveFileDialog saveFileDialog = new SaveFileDialog())
                {
                    ...
                    saveFileDialog.FileName = $"department_{DateTime.Today.Day}_{DateTime.Today.Month}_{DateTime.Today.Year}.json";
        ...
        private void вJSONИнформациюВыбранногоТовараToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            try
            {
                if (dataGridView1.CurrentRow != null && dataGridView1.CurrentRow.Cells[0].Value != null)
                {
                    using (SaveFileDialog saveFileDialog = new SaveFileDialog())
                    {
                        ...
                        saveFileDialog.Title = "Сохраните файл JSON как";
                        string code = (string)dataGridView1.CurrentRow.Cells[1].Value;
                        saveFileDialog.FileName = $"department_{code.Replace(" ", "_")}_{DateTime.Today.Day}_{DateTime.Today.Month}_{DateTime.Today.Year}.json";
