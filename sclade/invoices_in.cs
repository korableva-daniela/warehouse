...
namespace sclade
{
    ...
    public partial class invoices_in : Form
    {
        ...
        public int ind;
        public int div;
        public invoices_in(NpgsqlConnection con, int stor, int id_em, string num,int ind,int div)
        {
            this.div = div;
            this.ind = ind;
            this.num = num;
                ...
                try
                {
                    ...
                    if (comboBox1.Text != "Склад не выбран")
                    {
                        if ((textBox1.Text == "") & (textBox2.Text == ""))
                        {
                            ...
                            sql1 += " and  invoices_in.flag=0 ORDER BY invoices_in.num_invoices";
                        ...
                        else if ((textBox1.Text != "") & (textBox2.Text == ""))
                        {
                            ...
                            sql1 += textBox1.Text;
                            sql1 += "%' and  invoices_in.flag=0 ORDER BY  invoices_in.num_invoices ASC;";
                            NpgsqlDataAdapter da = new NpgsqlDataAdapter(sql1, con);
                            ds.Reset();
                            da.Fill(ds);
                    ...
                    else
                    {
                        if (comboBox1.Text == "Склад не выбран")
                        {
                            if ((textBox1.Text == "") & (textBox2.Text == ""))
                            {
                                String sql2 = "Select invoices_in.id,invoices_in.num_invoices, Firm.name_f,storehouse.name, invoices_in.data,invoices_in.num_Contract,invoices_in.total_sum,invoices_in.total_sum_nds,invoices_in.shipment,invoices_in.status, Employee.name,Firm.id ,invoices_in.Address_f from Firm,Address_f, storehouse,invoices_in,Employee where  invoices_in.Address_f=Address_f.id and Firm.id=invoices_in.id_Firm and invoices_in.id_storehouse=storehouse.id and Employee.id=invoices_in.id_Employee and  invoices_in.flag=0 and storehouse.id_div = " + this.div.ToString() + "  ORDER BY invoices_in.num_invoices";
                            ...
                            else if ((textBox1.Text != "") & (textBox2.Text == ""))
                            {
                                ...
                                sql2 += textBox1.Text;
                                sql2 += "%'  and  invoices_in.flag=0  and storehouse.id_div = " + this.div.ToString() + " ORDER BY  invoices_in.num_invoices ASC;";
        ...
        private void invoices_in_Load(object sender, EventArgs e)
        {
            try
            {
            ...
            try
            {
                if (dataGridView1.CurrentRow != null)
                {
                    if (this.id_em != -1)
                    {
                                ...
                                if (comboBox1.Text != "Склад не выбран")
                                {
                                    newinvoices_in fp = new newinvoices_in(con, -1, "", "", comboBox1.Text, "", 0, 0, "", this.id_em, DateTime.Today, DateTime.Today, -1,div);
                                    fp.ShowDialog();
                                }
                                else
                                {
                                    newinvoices_in fp = new newinvoices_in(con, -1, "", "", "", "", 0, 0, "", this.id_em, DateTime.Today, DateTime.Today, -1,div);
                                    fp.ShowDialog();
                                }
        ...
        private void адресToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dataGridView1.CurrentRow.Cells[0].Value != null)
                {
                    ...
                    int id_Firm = (int)dataGridView1.CurrentRow.Cells[11].Value;
                        ...
                        if (this.id_em == Convert.ToInt32(dt10.Rows[0]["id_Employee"]))
                        {
                            if (dataGridView1.CurrentRow.Cells[9].Value.ToString() == "Не указано")
                            {
                                ...
                                if (id > 0)
                                {
                                    ...
                                    newinvoices_in_info f = new newinvoices_in_info(con, -1, id, "", "", 0, 0, id_Firm, this.div);
                                    f.ShowDialog();
                                    //Update();
                                    updateinvoices_in_info(id);
                                }
                    ...
                    if (dt10.Rows.Count > 0)
                    {
                        if (this.id_em == Convert.ToInt32(dt10.Rows[0]["id_Employee"]))
                        {
                            if (dataGridView1.CurrentRow.Cells[9].Value.ToString()=="Не указано")
                            {
                                ...
                                newinvoices_in f = new newinvoices_in(con, id, num_invoices, id_Firm, id_storehouse, num_Contract, total_sum, total_sum_nds, status, this.id_em, data, shipment, address,div);
                                f.ShowDialog();
                                Update();
                                updateinvoices_in_info(id);
                            }
                ...
                if (dataGridView1.CurrentRow.Cells[0].Value != null)
                {
                    ...
                    if (dt10.Rows.Count > 0)
                    {
                        if (this.id_em == Convert.ToInt32(dt10.Rows[0]["id_Employee"]))
                        {
                            ...
                            newinvoices_in_info f = new newinvoices_in_info(con, id, id_invoices, id_Product_card, id_batch_number, quantity, price, id_Firm, this.div);
                            f.ShowDialog();
                            //Update();
                            updateinvoices_in_info(id);
                            }
        ...
        private void информацияОПоставщикеToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //ExportToExcel(dataGridView1, filePath);
                {
                    if (dataGridView1.CurrentRow != null)
                    {
                        ...
                        using (SaveFileDialog saveFileDialog = new SaveFileDialog())
                        {
                            ...
                            saveFileDialog.FileName = "invoices_in_info_" + comboBox1.Text.Replace(" ", "_") + "_" + code + "_" + DateTime.Today.Date.Day.ToString() + "_" + DateTime.Today.Date.Month.ToString() + "_" + DateTime.Today.Date.Year.ToString() + ".xlsx"; // Имя файла по умолчанию
                ...
                else
                {
                    if (dataGridView1.CurrentRow != null)
                    {
                        ...
                        using (SaveFileDialog saveFileDialog = new SaveFileDialog())
                        {
                            ...
                            DateTime time = DateTime.Today.Date;
                            string code = (string)dataGridView1.CurrentRow.Cells[1].Value;
                            saveFileDialog.FileName = "invoices_in_info_" + "_" + code + "_" + DateTime.Today.Date.Day.ToString() + "_" + DateTime.Today.Date.Month.ToString() + "_" + DateTime.Today.Date.Year.ToString() + ".xlsx"; // Имя файла по умолчанию
            ...
            try
            {
                ...
                //ExportToExcel(dataGridView1, filePath);
                {
                    using (SaveFileDialog saveFileDialog = new SaveFileDialog())
                    {
                        ...
                        saveFileDialog.FileName = "invoices_in_" + comboBox1.Text.Replace(" ", "_") + "_" + DateTime.Today.Date.Day.ToString() + "_" + DateTime.Today.Date.Month.ToString() + "_" + DateTime.Today.Date.Year.ToString() + ".xlsx"; // Имя файла по умолчанию
                ...
                else
                {
                    using (SaveFileDialog saveFileDialog = new SaveFileDialog())
                    {
                        ...
                        saveFileDialog.FileName = "invoices_in_" + DateTime.Today.Date.Day.ToString() + "_" + DateTime.Today.Date.Month.ToString() + "_" + DateTime.Today.Date.Year.ToString() + ".xlsx"; // Имя файла по умолчанию
                ...
                //ExportToExcel(dataGridView1, filePath);
                {
                    if (dataGridView1.CurrentRow != null)
                    {
                        ...
                        using (SaveFileDialog saveFileDialog = new SaveFileDialog())
                        {
                            ...
                            DateTime time = DateTime.Today.Date;
                            string code = (string)dataGridView1.CurrentRow.Cells[1].Value;
                            saveFileDialog.FileName = "invoices_in_" + comboBox1.Text.Replace(" ", "_") + "_" + code + "_" + DateTime.Today.Date.Day.ToString() + "_" + DateTime.Today.Date.Month.ToString() + "_" + DateTime.Today.Date.Year.ToString() + ".xlsx"; // Имя файла по умолчанию
                ...
                else
                {
                    if (dataGridView1.CurrentRow != null)
                    {
                        ...
                        using (SaveFileDialog saveFileDialog = new SaveFileDialog())
                        {
                            ...
                            DateTime time = DateTime.Today.Date;
                            string code = (string)dataGridView1.CurrentRow.Cells[1].Value;
                            saveFileDialog.FileName = "invoices_in_" + "_" + code + "_" + DateTime.Today.Date.Day.ToString() + "_" + DateTime.Today.Date.Month.ToString() + "_" + DateTime.Today.Date.Year.ToString() + ".xlsx"; // Имя файла по умолчанию
                ...
                if (dataGridView1.CurrentRow != null)
                {
                    ...
                    if (dt30.Rows.Count > 0)
                    {
                        using (SaveFileDialog saveFileDialog = new SaveFileDialog())
                        {
                            ...
                            saveFileDialog.FileName = "invoices_in_" + code + "_" + DateTime.Today.ToString("dd_MM_yyyy") + ".docx"; // Имя файла по умолчанию
                            ...
                            if (saveFileDialog.ShowDialog() == DialogResult.OK)
                            {
                                ...
                                worker.DoWork += (s, args) =>
                                {
                                    ...
                                    String sql1 = "Select CONCAT('  ',Firm.name_f, ' , ИНН: ',Firm.INN , ' , КПП: ',Firm.KPP, ' , ОГРН: ',Firm.OGRN, ' , р/с: ',Firm.pc, ' , название банка: ',Firm.bank, ' , бик:',Firm.bik, ' , адрес: ',Address_f.country_f, ' , ',Address_f.city_f, ' , ',Address_f.street_f, ' , ',Address_f.house_f, ' , ',Address_f.post_in_f) AS sender," +
                                    " CONCAT('  ',organization.name_f, ' , ИНН: ',organization.INN , ' , КПП: ',organization.KPP, ' , ОГРН: ',organization.OGRN, ' , р/с: ',organization.pc, ' , название банка: ',organization.bank, ' , бик: ',organization.bik,' Склад:  ', storehouse.name, ' , Подразделение: ', Division.name, ' , адрес: ', storehouse.country_d, ' , ', storehouse.city_d, ' ,  ', storehouse.street_d, ' ,  ', storehouse.house_d, ' , ', storehouse.post_in_d) AS recipient, " +
                                    " CONCAT('  ',organization.name_f, ' , ИНН: ',organization.INN , ' , КПП: ',organization.KPP, ' , ОГРН: ',organization.OGRN, ' , р/с: ',organization.pc, ' , название банка: ',organization.bank, ' , бик:',organization.bik) AS payer, " +
                                    " CONCAT('  ',Firm.name_f, ' , ИНН: ',Firm.INN , ' , КПП: ',Firm.KPP, ' , ОГРН: ',Firm.OGRN, ' , р/с: ',Firm.pc, ' , название банка: ',Firm.bank, ' , бик:',Firm.bik) AS provider, " +
            ...
            try
            {
                if (dataGridView1.CurrentRow != null && dataGridView1.CurrentRow.Cells[0].Value != null)
                {
                    using (SaveFileDialog saveFileDialog = new SaveFileDialog())
                    {
                        ...
                        string code = (string)dataGridView1.CurrentRow.Cells[1].Value;
                        saveFileDialog.FileName = $"invoices_in_{code.Replace(" ", "_")}_{DateTime.Today.Day}_{DateTime.Today.Month}_{DateTime.Today.Year}.json";
        ...
        private void вExcelВсеДанныеToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                using (SaveFileDialog saveFileDialog = new SaveFileDialog())
                {
                    saveFileDialog.Filter = "JSON files (*.json)|*.json|All files (*.*)|*.*";
                    saveFileDialog.Title = "Сохраните файл JSON как";
                    saveFileDialog.FileName = $"invoices_in_{DateTime.Today.Day}_{DateTime.Today.Month}_{DateTime.Today.Year}.json";
            ...
            try
            {
                if (dataGridView1.CurrentRow != null && dataGridView1.CurrentRow.Cells[0].Value != null)
                {
                    using (SaveFileDialog saveFileDialog = new SaveFileDialog())
                    {
                        ...
                        saveFileDialog.Title = "Сохраните файл JSON как";
                        string code = (string)dataGridView1.CurrentRow.Cells[1].Value;
                        saveFileDialog.FileName = $"invoices_in_address_{code.Replace(" ", "_")}_{DateTime.Today.Day}_{DateTime.Today.Month}_{DateTime.Today.Year}.json";
        ...
        private void вWordВсеДанныеToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                using (SaveFileDialog saveFileDialog = new SaveFileDialog())
                {
                    saveFileDialog.Filter = "Word Files|*.docx";
                    saveFileDialog.Title = "Сохранить файл Word";
                    saveFileDialog.FileName = "invoices_in_" + DateTime.Today.ToString("dd_MM_yyyy") + ".docx"; // Имя файла по умолчанию
