...
namespace sclade
{
    public partial class client_storehouse : Form
    {
        ...
        public client_storehouse(NpgsqlConnection con, int id, int id_Firm, int id_storehouse, int div)
        {
            this.con = con;
            InitializeComponent();
            this.id = id;
        ...
        private void client_storehouse_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (this.id == -1)
            {
                ...
                try
                {
                    ...
                    string sql = "Insert into client_storehouse (id_Firm, id_storehouse) values ( :id_Firm, :id_storehouse)";
