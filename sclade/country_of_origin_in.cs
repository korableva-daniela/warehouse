...
namespace sclade
{
    public partial class country_of_origin_in : Form
    {
        ...
        public country_of_origin_in(NpgsqlConnection con, int id, string name)
        {
            this.name = name;
            this.id = id;
            this.con = con;
        ...
        private void country_of_origin_in_Load(object sender, EventArgs e)
        {
            Update();
