...
namespace sclade
{
    public partial class firm_client : Form
    {
        ...
        public int div;
        public firm_client(NpgsqlConnection con, int id, string name,int stor,int div)
        {
            this.id = id;
            this.div = div;
            this.name = name;
        ...
        public void Update()
        {
            ...
            try
            {
                ...
                if (comboBox1.Text == "Склад не выбран")
                {
                    if (textBox1.Text == "")
                    {
                        String sql = "Select Firm.id,Firm.name_f,Firm.phone_f,Firm.view_,country_of_origin.litter,Firm.INN,Firm.KPP,Firm.OGRN,Firm.pc,Firm.bank,Firm.bik  from Firm,country_of_origin,client_storehouse where Firm.country_of_registration=country_of_origin.id and client_storehouse.id_Firm = Firm.id ORDER BY Firm.id ASC;";
                    ...
                    {
                        String sql = "Select Firm.id,Firm.name_f,Firm.phone_f,Firm.view_,country_of_origin.litter,Firm.INN,Firm.KPP,Firm.OGRN,Firm.pc,Firm.bank,Firm.bik  from Firm,country_of_origin,client_storehouse where Firm.country_of_registration=country_of_origin.id and client_storehouse.id_Firm = Firm.id and Firm.name_f  ILIKE '";
                        sql += textBox1.Text;
                ...
                else
                {
                    if (textBox1.Text == "")
                    {
                        String sql = "Select Firm.id,Firm.name_f,Firm.phone_f,Firm.view_,country_of_origin.litter,Firm.INN,Firm.KPP,Firm.OGRN,Firm.pc,Firm.bank,Firm.bik,client_storehouse.id,storehouse.name   from Firm,country_of_origin,client_storehouse,storehouse where Firm.country_of_registration=country_of_origin.id and client_storehouse.id_Firm = Firm.id ";
                        sql += " and client_storehouse.id_storehouse = storehouse.id and client_storehouse.id_storehouse = ";
                    ...
                    {
                        String sql = "Select Firm.id,Firm.name_f,Firm.phone_f,Firm.view_,country_of_origin.litter,Firm.INN,Firm.KPP,Firm.OGRN,Firm.pc,Firm.bank,Firm.bik,client_storehouse.id,storehouse.name  from Firm,country_of_origin,client_storehouse,storehouse where Firm.country_of_registration=country_of_origin.id and Firm.name_f  ILIKE '";
                        sql += textBox1.Text;
                        sql += "%' and client_storehouse.id_storehouse = storehouse.id and client_storehouse.id_storehouse =";
        ...
        private void firm_client_Load(object sender, EventArgs e)
        {
            try
            {
                Update();
            ...
            try
            {
                ...
                if (dataGridView1.CurrentRow != null)
                    ...
                    else 
                   {
                        if (comboBox1.Text != "Склад не выбран")
                        {
                            String sql1 = "Select Firm.id as f from Firm ,client_storehouse where client_storehouse.id_storehouse = " + this.stor.ToString() + " and client_storehouse.id_Firm=Firm.id   ORDER BY Firm.name_f ASC LIMIT 1 ;";
                        ...
                        {
                            String sql1 = "Select Firm.id as f  from Firm,client_storehouse where client_storehouse.id_Firm=Firm.id ORDER BY Firm.name_f ASC LIMIT 1 ;";
                            NpgsqlDataAdapter da6 = new NpgsqlDataAdapter(sql1, con);
                            ds6.Reset();
                            da6.Fill(ds6);
                            dt6 = ds6.Tables[0];
        ...
        private void добавитьToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                    ...
                    {
                        client_storehouse f = new client_storehouse(con, -1, -1, (int)comboBox1.SelectedValue,div);
                        f.ShowDialog();
                        Update();
                    }
        ...
        private void удалитьToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                if (dataGridView1.CurrentRow.Cells[11].Value != null)
                {
                    ...
                    NpgsqlCommand command = new NpgsqlCommand("DELETE FROM  client_storehouse   WHERE id=:id", con);
        ...
        private void ExportToWord_all(DataGridView dataGridView, DataGridView dataGridView3, string filePath)
        {
            ...
            try
            {
                ...
                if (comboBox1.Text != "Склад не выбран")
                {
                    titleParagraph.Range.Text = "Клиенты. Склада: " + comboBox1.Text;
                }
                else
                {
                    titleParagraph.Range.Text = "Клиенты";
                }
        ...
        private void ExportToWord(DataGridView dataGridView, DataGridView dataGridView3, string filePath)
        {
            ...
            try
            {
                if (dataGridView1.CurrentRow != null && dataGridView1.CurrentRow.Cells[0].Value != null)
                {
                    ...
                    if (comboBox1.Text != "Склад не выбран")
                    {
                        titleParagraph.Range.Text = "Клиент. Склада: " + comboBox1.Text;
                    }
                    else
                    {
                        titleParagraph.Range.Text = "Клиент";
                    }
                    titleParagraph.Range.Font.Name = "Arial"; // Устанавливаем шрифт
                    titleParagraph.Range.Font.Size = 12;
            ...
            try
            {
                ...
                //ExportToExcel(dataGridView1, filePath);
                {
                    using (SaveFileDialog saveFileDialog = new SaveFileDialog())
                    {
                        ...
                        saveFileDialog.FileName = "clients_" + comboBox1.Text.Replace(" ", "_") + "_" + DateTime.Today.Date.Day.ToString() + "_" + DateTime.Today.Date.Month.ToString() + "_" + DateTime.Today.Date.Year.ToString() + ".xlsx"; // Имя файла по умолчанию
                ...
                else
                {
                    using (SaveFileDialog saveFileDialog = new SaveFileDialog())
                    {
                        ...
                        saveFileDialog.FileName = "clients_" + DateTime.Today.Date.Day.ToString() + "_" + DateTime.Today.Date.Month.ToString() + "_" + DateTime.Today.Date.Year.ToString() + ".xlsx"; // Имя файла по умолчанию
                ...
                //ExportToExcel(dataGridView1, filePath);
                {
                    if (dataGridView1.CurrentRow != null)
                    {
                        ...
                        using (SaveFileDialog saveFileDialog = new SaveFileDialog())
                        {
                            ...
                            DateTime time = DateTime.Today.Date;
                            string code = (string)dataGridView1.CurrentRow.Cells[1].Value;
                            saveFileDialog.FileName = "client_" + comboBox1.Text.Replace(" ", "_") + "_" + code.Replace(" ", "_") + "_" + DateTime.Today.Date.Day.ToString() + "_" + DateTime.Today.Date.Month.ToString() + "_" + DateTime.Today.Date.Year.ToString() + ".xlsx"; // Имя файла по умолчанию
                ...
                else
                {
                    if (dataGridView1.CurrentRow != null)
                    {
                        ...
                        using (SaveFileDialog saveFileDialog = new SaveFileDialog())
                        {
                            ...
                            DateTime time = DateTime.Today.Date;
                            string code = (string)dataGridView1.CurrentRow.Cells[1].Value;
                            saveFileDialog.FileName = "client_" + "_" + code.Replace(" ", "_") + "_" + DateTime.Today.Date.Day.ToString() + "_" + DateTime.Today.Date.Month.ToString() + "_" + DateTime.Today.Date.Year.ToString() + ".xlsx"; // Имя файла по умолчанию
                ...
                //ExportToExcel(dataGridView1, filePath);
                {
                    if (dataGridView1.CurrentRow != null)
                    {
                        ...
                        using (SaveFileDialog saveFileDialog = new SaveFileDialog())
                        {
                            ...
                            DateTime time = DateTime.Today.Date;
                            string code = (string)dataGridView1.CurrentRow.Cells[1].Value;
                            saveFileDialog.FileName = "client_address_" + comboBox1.Text.Replace(" ", "_") + "_" + code.Replace(" ", "_") + "_" + DateTime.Today.Date.Day.ToString() + "_" + DateTime.Today.Date.Month.ToString() + "_" + DateTime.Today.Date.Year.ToString() + ".xlsx"; // Имя файла по умолчанию
                ...
                else
                {
                    if (dataGridView1.CurrentRow != null)
                    {
                        ...
                        using (SaveFileDialog saveFileDialog = new SaveFileDialog())
                        {
                            ...
                            DateTime time = DateTime.Today.Date;
                            string code = (string)dataGridView1.CurrentRow.Cells[1].Value;
                            saveFileDialog.FileName = "client_address_" + "_" + code.Replace(" ", "_") + "_" + DateTime.Today.Date.Day.ToString() + "_" + DateTime.Today.Date.Month.ToString() + "_" + DateTime.Today.Date.Year.ToString() + ".xlsx"; // Имя файла по умолчанию
            ...
            try
            {
                ...
                //ExportToExcel(dataGridView1, filePath);
                {
                    ...
                    using (SaveFileDialog saveFileDialog = new SaveFileDialog())
                    {
                        ...
                        saveFileDialog.FileName = "client_" + comboBox1.Text.Replace(" ", "_") + "_" + DateTime.Today.ToString("dd_MM_yyyy") + ".docx"; // Имя файла по умолчанию
                ...
                else
                {
                    using (SaveFileDialog saveFileDialog = new SaveFileDialog())
                    {
                        saveFileDialog.Filter = "Word Files|*.docx";
                        saveFileDialog.Title = "Сохранить файл Word";
                        saveFileDialog.FileName = "client_" + DateTime.Today.ToString("dd_MM_yyyy") + ".docx"; // Имя файла по умолчанию
                ...
                if (dataGridView1.CurrentRow != null && dataGridView1.CurrentRow.Cells[0].Value != null)
                {
                    ...
                    //ExportToExcel(dataGridView1, filePath);
                    {
                        using (SaveFileDialog saveFileDialog = new SaveFileDialog())
                        {
                            ...
                            saveFileDialog.Title = "Сохранить файл Word";
                            string code = (string)dataGridView1.CurrentRow.Cells[1].Value;
                            saveFileDialog.FileName = "client_" + comboBox1.Text.Replace(" ", "_") + "_" + code.Replace(" ", "_") + "_" + DateTime.Today.ToString("dd_MM_yyyy") + ".docx"; // Имя файла по умолчанию
                    ...
                    else
                    {
                        using (SaveFileDialog saveFileDialog = new SaveFileDialog())
                        {
                            ...
                            saveFileDialog.Title = "Сохранить файл Word";
                            string code = (string)dataGridView1.CurrentRow.Cells[1].Value;
                            saveFileDialog.FileName = "client_" + code.Replace(" ", "_") + "_" + DateTime.Today.ToString("dd_MM_yyyy") + ".docx"; // Имя файла по умолчанию
                ...
                if (dataGridView1.CurrentRow != null && dataGridView1.CurrentRow.Cells[0].Value != null)
                {
                    ...
                    //ExportToExcel(dataGridView1, filePath);
                    {
                        using (SaveFileDialog saveFileDialog = new SaveFileDialog())
                        {
                            ...
                            saveFileDialog.Title = "Сохранить файл Word";
                            string code = (string)dataGridView1.CurrentRow.Cells[1].Value;
                            saveFileDialog.FileName = $"client_address_" + comboBox1.Text.Replace(" ", "_") + "_" + code.Replace(" ", "_") + "_" + DateTime.Today.ToString("dd_MM_yyyy") + ".docx";
                    ...
                    else
                    {
                        using (SaveFileDialog saveFileDialog = new SaveFileDialog())
                        {
                            ...
                            saveFileDialog.Title = "Сохранить файл Word";
                            string code = (string)dataGridView1.CurrentRow.Cells[1].Value;
                            saveFileDialog.FileName = $"client_address_" + code.Replace(" ", "_") + "_" + DateTime.Today.ToString("dd_MM_yyyy") + ".docx";
            ...
            try
            {
                ...
                //ExportToExcel(dataGridView1, filePath);
                {
                    using (SaveFileDialog saveFileDialog = new SaveFileDialog())
                    {
                        ...
                        saveFileDialog.FileName = $"client_{comboBox1.Text.Replace(" ", "_")}_{DateTime.Today.Day}_{DateTime.Today.Month}_{DateTime.Today.Year}.json";
            ...
            try
            {
                if (dataGridView1.CurrentRow != null && dataGridView1.CurrentRow.Cells[0].Value != null)
                {
                        ...
                        using (SaveFileDialog saveFileDialog = new SaveFileDialog())
                    {
                        ...
                        saveFileDialog.Title = "Сохраните файл JSON как";
                        string code = (string)dataGridView1.CurrentRow.Cells[1].Value;
                        saveFileDialog.FileName = $"client_{comboBox1.Text.Replace(" ", "_")}_{code.Replace(" ", "_")}_{DateTime.Today.Day}_{DateTime.Today.Month}_{DateTime.Today.Year}.json";
            ...
            try
            {
                if (dataGridView1.CurrentRow != null && dataGridView1.CurrentRow.Cells[0].Value != null)
                {
                        ...
                        using (SaveFileDialog saveFileDialog = new SaveFileDialog())
                    {
                        ...
                        saveFileDialog.Title = "Сохраните файл JSON как";
                        string code = (string)dataGridView1.CurrentRow.Cells[1].Value;
                        saveFileDialog.FileName = $"client_address_{comboBox1.Text.Replace(" ", "_")}_{code.Replace(" ", "_")}_{DateTime.Today.Day}_{DateTime.Today.Month}_{DateTime.Today.Year}.json";
