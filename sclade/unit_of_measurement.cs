...
namespace sclade
{
    public partial class unit_of_measurement : Form
    {
        ...
        public unit_of_measurement(NpgsqlConnection con)
        {
            this.con = con;
            InitializeComponent();
        ...
        private void unit_of_measurement_Load(object sender, EventArgs e)
        {
            Update();
        }
        public void Update()
        ...
        private void добавитьToolStripMenuItem_Click(object sender, EventArgs e)
        {
                try
                {
                    newunit_of_measurement f = new newunit_of_measurement(con, -1, "", "", "");
            f.ShowDialog();
            Update();
            }
            catch { }
        ...
        private void изменитьToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            newunit_of_measurement f = new newunit_of_measurement(con, id, code, name, litter);
            f.ShowDialog();
            Update();
                }
                catch { }
        ...
        private void удалитьToolStripMenuItem_Click(object sender, EventArgs e)
        {
                try
                {
                    ...
                    NpgsqlCommand command = new NpgsqlCommand("DELETE FROM unit_of_measurement WHERE id=:id", con);
